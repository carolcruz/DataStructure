...
This program solves the following problem:
  ...
  at the time of program execution, as this will allow kitchen staff to: insert new dishes, remove and change dishes. Daily billing
  will only be stored on file for the restaurant owner to have access to.
...
The data structures used in this programs:
			...
			- file (that saves the menu and daily billing in secondary memory, to maintain the data)
The operations:
...
void saveList(){
    ...
    aux = begList;
    while(aux!=NULL){
        fwrite(&aux->name, sizeof(char), 50, file);
        fwrite(&aux->price, sizeof(float), 1, file);
        aux = aux->nextDish;
    }
	fclose(file);
}
...
void menu2(){
    printf("\t KODEL'S DRIVE THRU: Client \t \n \n");
    printf("1. View Menu\n2. Back\n");
    int option;
    printf("Option: ");
    scanf("%d", &option);
...
void menu3(){
    printf("\t KODEL'S DRIVE THRU: Menu \t \n \n");
    printList();
    printf("\n1. Place Order\n0. Back\n");
    int option;
    printf("Option: ");
    ...
    if(option == 0){
        ...
        do{
            if(i == dish){
              ...
              addQueue(aux2);
              printf("Request done successfully!\n");
              //printQueue();
              a++;
            }
            i++;
...
void menu4(){
     printf("\t KODEL'S DRIVE THRU: Kitchen \t \n \n");
...
void menu5(){
    printf("\t KODEL'S DRIVE THRU: Add to Menu \t \n \n");
    char name[50];
    float price;
    dishes aux;
    printf("Name: ");
...
void menu6(){
    printf("\t KODEL'S DRIVE THRU: Remove from Menu \t \n \n");
    char name[50];
...
void menu7(){
    printf("\t KODEL'S DRIVE THRU: Change Menu \t \n \n");
...
void menu8(){
        int done;
        do{
            printf("\t KODEL'S DRIVE THRU: Dishes Queue \t \n \n");
            printQueue();
            printf("1. Done\n0. Back\nOption: ");
            scanf("%d", &done);
